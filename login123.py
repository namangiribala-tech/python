...
def addcustomer1():
 ...
 while ch=='y':
      ...
      cr.execute(s)
      con.commit()
      ch=input('do you want to add more customer..y/n')
...
def deletecustomer():
      print('you have selected to delete the information of existing customer')
      gy='y'
      while gy=='y':
       print('check the customer details ')
       print('1.name')
       print('2.customer id')
       c=input('enter the method no')
       if c=='1':
             e=input('enter the name of the customer')
             s="select * from customer where name='{}'".format(e)
             cr.execute(s)
             d=cr.fetchall()
             for i in d:
                   for j in i:
             ...
             e=int(input('enter the id of the customer'))
             s="select * from customer where customerid={}".format(e)
             cr.execute(s)
             d=cr.fetchall()
             for i in d:
                   for j in i:
             ...
             print()
       print('check the details carefully')
       iid=int(input('enter the id of the customer you want to delete of'))
       s='delete from customer where customerid={}'.format(iid)
       cr.execute(s)
       con.commit()
       gy=input('do you want to continue deleting more customer y/n')
...
def updatecustomer():
     print('you have selected to update the information of existing customer')
     gg='y'
     while gg=='y':
       print('check the customer details ')
       print('1.name')
       ...
       if c=='1':
             ...
             print()
       print('check the details carefully')
       iid=int(input('enter the id of the customer you want to update of'))
       print ('what do you want to update of the employee')
       print('1. phone no')
       print('2. address')
       print('one at each time')
       up=input('enter the method number')
       if up=='1':
             print('you want to update the phone no of the employee')
             u=int(input('enter the new phone no of the customer'))
             sc="update customer set phno ={} where customerid={}".format(u,iid)
             cr.execute(sc)
             con.commit()
             gg=input('do you ewant to update more datas')
       elif up=='2':
             print('you want to update the  address of the customer')
             u=input('enter the new address of the customer')
             sc="update customer set address='{}' where customerid={}".format(u,iid)
             cr.execute(sc)
             con.commit()
             gg=input('do you ewant to update more datas')
...
def customermenu():
  ch='y'
  while ch=='y':
      print("--- welcome to customer Management Menu ---")
      ...
      if c=='1':
            ...
            break
      ch=input('do you want to continue more want customwr menu.. y/n')
